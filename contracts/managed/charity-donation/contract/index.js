...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      initialize: (...args_1) => {
        ...
        const organizer_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('initialize',
                                     'argument 1 (as invoked from Typescript)',
                                     'charity_donation.compact line 51 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(organizer_0),
      ...
      createCampaign: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`createCampaign: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const title_0 = args_1[1];
        const callerAddress_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('createCampaign',
                                     'argument 1 (as invoked from Typescript)',
                                     'charity_donation.compact line 59 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(title_0).concat(_descriptor_0.toValue(callerAddress_0)),
      ...
      donate: (...args_1) => {
        ...
        const contextOrig_0 = args_1[0];
        const donorSecret_0 = args_1[1];
        const amount_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('donate',
                                     'argument 1 (as invoked from Typescript)',
                                     'charity_donation.compact line 74 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(donorSecret_0.buffer instanceof ArrayBuffer && donorSecret_0.BYTES_PER_ELEMENT === 1 && donorSecret_0.length === 32)) {
          __compactRuntime.typeError('donate',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_2.toValue(donorSecret_0).concat(_descriptor_1.toValue(amount_0)),
  ...
  _initialize_0(context, partialProofData, organizer_0) {
  ...
  _createCampaign_0(context, partialProofData, title_0, callerAddress_0) {
    const disclosedCaller_0 = callerAddress_0;
    __compactRuntime.assert(disclosedCaller_0
                            ===
                            _descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      ...
                                                                                      [
                                                                                       ...
                                                                                       { popeq: { cached: false,
                                                                                                  result: undefined } }]).value),
                            'Unauthorized: caller is not the organizer');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_7.toValue(2n),
                                                                                              alignment: _descriptor_7.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(title_0),
                                                                                              alignment: _descriptor_0.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('charity_donation.compact line 67 char 21: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
  ...
  _donate_0(context, partialProofData, donorSecret_0, amount_0) {
    __compactRuntime.assert(amount_0 > 0n,
                            'Donation amount must be greater than zero');
    const nullifier_0 = this._persistentHash_0(donorSecret_0);
    __compactRuntime.assert(!_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                       partialProofData,
                                                                                       [
                                                                                        { dup: { n: 0 } },
                                                                                        ...
                                                                                        { popeq: { cached: true,
                                                                                                   result: undefined } }]).value),
                            'Donation already submitted: nullifier reused');
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
    ...
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('charity_donation.compact line 92 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
                  })(_descriptor_1.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               partialProofData,
      ...
      member(...args_0) {
        ...
        if (!(elem_0.buffer instanceof ArrayBuffer && elem_0.BYTES_PER_ELEMENT === 1 && elem_0.length === 32)) {
          __compactRuntime.typeError('member',
                                     'argument 1',
                                     'charity_donation.compact line 47 char 1',
                                     'Bytes<32>',
                                     elem_0)
        }
        return _descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
